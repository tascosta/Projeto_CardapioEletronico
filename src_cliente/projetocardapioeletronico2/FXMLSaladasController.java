 ...
 * @author isabe
 */
public class FXMLSaladasController implements Initializable {
    @FXML
    private Button btnCarrinho;
    @FXML
    private Pane paneSalada;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            criarCategoriaSalada();
        } catch (IOException ex) {
            Logger.getLogger(FXMLSaladasController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
    
    @FXML
    private void btnCarrinho(ActionEvent event) throws IOException {
    ...
    public void criarCategoriaSalada() throws IOException {
        ...
        for (Produto prd : daoproduto.getbuscarProdutosBD()) {
            ...
            if (prd.getCategoria().equalsIgnoreCase(categoria)) {
                try {
                    ...
                    paneSalada.getChildren().add(telinhaProduto);
