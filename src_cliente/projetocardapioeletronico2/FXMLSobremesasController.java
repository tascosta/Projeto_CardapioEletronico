 ...
 * @author isabe
 */
public class FXMLSobremesasController implements Initializable {

    @FXML
    private Button btnMenuCarrinho;
    @FXML
    private Pane paneSobremesas;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            criarCategoriaSabremesas();
        } catch (IOException ex) {
            Logger.getLogger(FXMLSobremesasController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void criarCategoriaSabremesas() throws IOException {
        ...
        for (Produto prd : daoproduto.getbuscarProdutosBD()) {
            ...
            if (prd.getCategoria().equalsIgnoreCase(categoria)) {
                try {
                    ...
                    paneSobremesas.getChildren().add(telinhaProduto);
